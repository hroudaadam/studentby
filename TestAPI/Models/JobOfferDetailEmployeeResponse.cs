...
namespace TestAPI.Models
{
    public class JobOfferDetailEmployeeResponse
    {
        ...
        public JobOfferDetailEmployeeResponse(JobOffer job, ICollection<JobApplication> jobApplications)
        {
            ...
            Start = job.Start;
            End = job.End;
            MapJobApplications(jobApplications);
        }

        private void MapJobApplications(ICollection<JobApplication> jobApplications)
        {
            ...
            this.ApprovedJobApplications = output;
        }
    }
}