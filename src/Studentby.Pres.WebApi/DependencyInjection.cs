...
using Studentby.Pres.WebApi.Security;
using Studentby.Shared.Exceptions;
using System.Globalization;

namespace Studentby.Pres.WebApi;
...
public static class DependencyInjection
{
    public static IServiceCollection AddWebApi(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            //c.IncludeXmlComments(string.Format(@"{0}\Studentby.WebApi.xml", System.AppDomain.CurrentDomain.BaseDirectory));
